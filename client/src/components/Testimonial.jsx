...
const Testimonial = () => {
    ...
    const testimonials = [
        ...
        {  name: "John Smith", Location: "New York, USA", image:assets.testimonial_image_2, testimonial: "CarRental made my trip so much easier. The car was delivered right to my door, and and customer service was fantastic!" },
        {  name: "Ava Johnson", Location: "sydney, Australia", image:assets.testimonial_image_2, testimonial: "I highly recommend CarRental! Their fleet is amazing, and I always feel like I'm getting the best deal with excellent service." }
    ];
