...
const AddCar = () => {
  ...
  const onSubmitHandler = async(e) => {
    ...
    try {
      ...
      const { data  } = await axios.post('/api/owner/add-car',formData,{headers:{
  ...
  return (
    <div className='p-4 py-10 md:p-10 flex-1'>
      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          <div className='flex flex-col w-full'>
            <label>Year</label>
            <input type="number" required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' placeholder={new Date().toISOString().split('-')[0]} value={car.year} onChange={(e) => setCar({...car, year:e.target.value})} />
          </div>
          <div className='flex flex-col w-full'>
          ...
          <div className='flex flex-col w-full'>
            ...
            <select  required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.category} onChange={(e) => setCar({...car, category:e.target.value})} >
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          <div className='flex flex-col w-full'>
            ...
            <select required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'  value={car.transmission} onChange={(e) => setCar({...car, transmission:e.target.value})} >
          ...
          <div className='flex flex-col w-full'>
            ...
            <select required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none'  value={car.fuelType} onChange={(e) => setCar({...car, fuelType:e.target.value})} >
